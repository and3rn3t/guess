...
export const CHARACTER_TYPE_PROFILES: CharacterTypeProfile[] = [
  {
    ...
    recommendedAttributes: ['wearsCape', 'wearsMask', 'hasSidekick', 'livesInCity', 'hasWeapon', 'canFly', 'hasArmor', 'usesVehicle', 'isBrave', 'isConfident', 'isLoyal'],
    optionalAttributes: ['hasWebShooters', 'climbsWalls', 'hasSpiderSense', 'livesInNewYork', 'isRobot', 'canRegenerate', 'shootsLasers', 'isSerious', 'isHonest', 'isCaring'],
  },
  {
    ...
    recommendedAttributes: ['hasSuperpowers', 'hasMagicPowers', 'hasWeapon', 'hasArmor', 'isLeader', 'hasMinions', 'canShapeshift', 'isArrogant', 'isAmbitious', 'isRuthless'],
    optionalAttributes: ['canTeleport', 'isImmortal', 'fromSpace', 'usesVehicle', 'wearsMask', 'hasTentacles', 'controlsWeather', 'isCunning', 'isDeceptive', 'isAggressive'],
  },
  {
...
export const ALL_KNOWN_ATTRIBUTES: Record<string, string> = {
  ...
  hasFur: 'Has Fur',
  isBrave: 'Brave/Courageous',
  isIntelligent: 'Intelligent/Smart',
  isWise: 'Wise',
  isArrogant: 'Arrogant/Prideful',
  isLoyal: 'Loyal',
  isCunning: 'Cunning/Clever',
  isOptimistic: 'Optimistic/Cheerful',
  isPessimistic: 'Pessimistic/Gloomy',
  isShy: 'Shy/Timid',
  isConfident: 'Confident',
  isAggressive: 'Aggressive/Violent',
  isGentle: 'Gentle/Kind',
  isSerious: 'Serious/Stoic',
  isPlayful: 'Playful',
  isHonest: 'Honest/Truthful',
  isDeceptive: 'Deceptive/Manipulative',
  isPatient: 'Patient',
  isImpulsive: 'Impulsive/Reckless',
  isAmbitious: 'Ambitious',
  isLazy: 'Lazy',
  isCreative: 'Creative/Artistic',
  isCaring: 'Caring/Compassionate',
  isSelfish: 'Selfish',
  isMerciful: 'Merciful/Forgiving',
  isRuthless: 'Ruthless',
  isHumble: 'Humble',
  isJealous: 'Jealous/Envious',
  isIndependent: 'Independent',
  isTeamPlayer: 'Team Player',
  isRebellious: 'Rebellious',
}
