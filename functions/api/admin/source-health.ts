...
import { computeSourceHealthReport, type SourceHealthCharacterRow } from '../_source_health'
...
export const onRequestGet: PagesFunction<Env> = async (context) => {
  ...
  const rate = await checkRateLimitBestEffort(env, actorId, 'admin.source-health.read', 300)
