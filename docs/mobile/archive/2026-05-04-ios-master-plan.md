# iOS Master Plan (Archived 2026-05-04)

This file is archived and kept for historical context.

Current active planning is now split across:

- `ROADMAP.md` (active mobile execution queue and status)
- `docs/mobile/roadmap-foundations.md` (foundational mobile roadmap details and acceptance criteria)
...
Outputs: go/no-go decision and documented risk acceptance if needed.
...
Before milestone and production sign-off for mobile:

1. `pnpm mobile:scorecard -- --gate=milestone`
2. `pnpm mobile:scorecard -- --gate=production`
