...
| **Player Compare** | GamePhaseRouter → CompareRoute | `screens/CompareScreen.tsx` → `/compare` route | ✅ Shipped | L1 | L1 | MVP: relative rank, player count ahead, category breakdowns | mobile | 2026-05-07 | `screen-quality-scores.json` (Compare-L1-mvp) |
...
| **Player Preferences** | GamePhaseRouter → PreferencesRoute | `screens/PreferencesScreen.tsx` → `/preferences` route | ✅ Shipped | L1 | L1 | MVP: difficulty selector, category toggles, accessibility toggles | mobile | 2026-05-07 | `screen-quality-scores.json` (Preferences-L1-mvp) |
...
| **Post-Game Feedback** | GamePhaseRouter → PostGameFeedbackRoute | `screens/PostGameFeedbackScreen.tsx` → `/feedback` route | ✅ Shipped | L1 | L1 | MVP: emoji reaction, difficulty rating (easy/medium/hard) | mobile | 2026-05-07 | `screen-quality-scores.json` (PostGameFeedback-L1-mvp) |
