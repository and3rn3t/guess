...
| `pnpm mobile:dev:device` | Start Expo dev server for physical iOS device with tunnel-backed dev-client and EXPO_PUBLIC_API_BASE_URL auto-set to the Mac LAN IP |
