...
- ▶ **Up next:** Wave 3 #28 — [AP.20](#ap-20) health badge in shell header
...
- ✅ **Recently shipped (last 5):** [AN.33](#an-33) anomaly-trigger alerts (2026-04-30) · [AN.30](#an-30) live ops strip in admin header (2026-04-30) · [AP.5](#ap-5) per-route error boundary with Retry (2026-04-30) · [AP.2](#ap-2) admin action round-trip tests (2026-04-30) · [DX.10](#dx-10) tag-driven release workflow (2026-04-30) · …see [CHANGELOG.md](CHANGELOG.md) for the full v1.6.0 list.
