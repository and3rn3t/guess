...
- ▶ **Up next:** Wave 4 #31 — [AN.17](#an-17) question retirement queue
...
- ✅ **Recently shipped (last 5):** [AN.7](#an-7) confusion matrix from real games (2026-05-01) · [AN.1](#an-1) question skip & frustration funnel (2026-04-30) · [AP.20](#ap-20) health badge in shell header (2026-04-30) · [AN.33](#an-33) anomaly-trigger alerts (2026-04-30) · [AN.30](#an-30) live ops strip in admin header (2026-04-30) · …see [CHANGELOG.md](CHANGELOG.md) for the full v1.6.0 list.
