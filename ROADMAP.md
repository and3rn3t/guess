...
- ▶ **Up next:** Wave 3 #30 — next ⬜ row after AN.1
...
- ✅ **Recently shipped (last 5):** [AN.1](#an-1) question skip & frustration funnel (2026-04-30) · [AP.20](#ap-20) health badge in shell header (2026-04-30) · [AN.33](#an-33) anomaly-trigger alerts (2026-04-30) · [AN.30](#an-30) live ops strip in admin header (2026-04-30) · [AP.5](#ap-5) per-route error boundary with Retry (2026-04-30) · …see [CHANGELOG.md](CHANGELOG.md) for the full v1.6.0 list.
