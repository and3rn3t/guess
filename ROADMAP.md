...
- ▶ **Up next:** Wave 2 #13 — **[DQ.21](#dq-21)** Schema drift detector (constraints + prompt) (S)
- 🧫 **Blocked / waiting on:** _none_
- 🎯 **Current wave focus:** Wave 2 — Data Quality Foundation. DQ.1 + DQ.2 shipped; vision agreement at 92.04% on golden set.
- ✅ **Recently shipped:** [DQ.2](#dq-2) vision validation gate (2026-04-30) · [DQ.1](#dq-1) golden regression set + CI gate (2026-04-30) · [H.4](#h-4) source map upload (2026-04-30) · [H.3](#h-3) Cron Worker entry (2026-04-30) · [DX.17](#dx-17), [H.1](#h-1), [H.2](#h-2) (2026-04-30) · [DX.11](#dx-11), [DX.12](#dx-12), [I.8](#i-8) (2026-04-30, audit-flip)
