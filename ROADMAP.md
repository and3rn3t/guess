...
- ⬜ **Next:** [RF.v2.5](#rfv2-5) (admin API client consolidation — `adminApi.ts` already on generated types; remaining work = sweep direct `httpClient.getJson<…>` call sites in admin route components onto generated types).
