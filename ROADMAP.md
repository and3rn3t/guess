...
- ✅ **Recently shipped (last 5):** [DX.10](#dx-10) tag-driven release workflow (2026-04-30) · [AP.1](#ap-1) admin route smoke-test sweep (2026-04-30) · [I.4](#i-4) Tail Worker observability (2026-04-30) · [I.2](#i-2) Workers Analytics Engine for LLM costs (2026-04-30) · [DQ.5](#dq-5) player-answer corroboration loop (2026-04-30) · …see [CHANGELOG.md](CHANGELOG.md) for the full v1.6.0 list.
